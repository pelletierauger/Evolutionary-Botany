let DNA = function() {
    ...
    // Branching struture
    this.branchGrowth = 0.0075;
    this.branchingAngle = Math.PI * 0.15;
    this.branchingProbability = 0.09;
    ...
    // Leaf structure
    this.petioleSegmentGrowth = 0.01;
