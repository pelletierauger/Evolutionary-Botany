...
const blurryFolder = "/Users/guillaumepelletier/Desktop/Dropbox/Art/p5/Evolutionary-Botany/frames/short-film-001-blur-bright";
const blurryFolder2 = "/Users/guillaumepelletier/Desktop/Dropbox/Art/p5/Evolutionary-Botany/frames/short-film-001-blur";
...
for (let i = 0; i < 250; i++) {
    ...
    Promise.all(currentFiles).then(function(data) {
        ...
        data[0].write("/Users/guillaumepelletier/Desktop/Dropbox/Art/p5/Evolutionary-Botany/frames/short-film-001-composite" + fileName, function() {
            console.log("wrote /Users/guillaumepelletier/Desktop/Dropbox/Art/p5/Evolutionary-Botany/frames/short-film-001-composite" + fileName);
        });
    });
}