...
const folder = "/Users/guillaumepelletier/Desktop/Dropbox/Art/p5/Post-Production/loop-010-bright-02";

const blurryFolder = "/Users/guillaumepelletier/Desktop/Dropbox/Art/p5/Post-Production/loop-010-bright-02";
...
for (let i = 0; i < 1; i++) {
    ...
    Promise.all(currentFiles).then(function(data) {
        ...
        data[0].write("./loop-010-bright-03test/" + fileName, function() {
            console.log("wrote ./loop-010-bright-03test/" + fileName);
        });
    });
}